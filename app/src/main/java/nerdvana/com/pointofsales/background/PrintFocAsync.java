...
public class PrintFocAsync extends AsyncTask<Void, Void, Void> {
    ...
    public PrintFocAsync(PrintModel printModel, Context context,
    ...
    protected Void doInBackground(Void... voids) {
        ...
        if (SharedPreferenceManager.getString(context, ApplicationConstants.SELECTED_PRINTER_MANUALLY).equalsIgnoreCase("sunmi")) {
            ...
            if (toList1 != null) {
                ...
                if (toList1.get_void() == 1) {
                    finalString += receiptString("REF FOC NO", toList1.getReceiptNo() == null ? "NOT YET CHECKOUT" : toList1.getReceiptNo().toString(), context, false);

                } else {
                    finalString += receiptString("FOC NO", toList1.getReceiptNo() == null ? "NOT YET CHECKOUT" : toList1.getReceiptNo().toString(), context, false);
                }
...
//                        }
                ...
                if (!printModel.getType().equalsIgnoreCase("takeout")) {
                    finalString += receiptString("ROOM NO", String.valueOf(printModel.getRoomNumber()), context, false);
                }
...
//                    returnWithTwoDecimal(String.valueOf(toList1.getTotalQty())), context, false);
                ...
                finalString += receiptString("   ADVANCED DEPOSIT", toList1.getAdvance() > 0 ? String.format("-%s", returnWithTwoDecimal(String.valueOf(toList1.getAdvance()))) : returnWithTwoDecimal(String.valueOf(toList1.getAdvance())), context, false);
...
//            }
                ...
                finalString += receiptString(new String(new char[Integer.valueOf(SharedPreferenceManager.getString(context, ApplicationConstants.MAX_COLUMN_COUNT))]).replace("\0", "-"),
                        "", context, true);
...
//            asyncFinishCallBack.doneProcessing();
                ...
                if (toList1 != null) {
                    ...
                    if (toList1.getGuestInfo() != null) {
                        if (toList1.getGuestInfo().getCashierOut() != null) {
                            addTextToPrinter(printer, twoColumnsRightGreaterTr(
                                    toList1.getxSkip() == 0 ? "CASHIER" : "CASHIERx",
...
//            }
                    ...
                    for (FetchOrderPendingViaControlNoResponse.Payment pym : toList1.getPayments()) {
                        ...
                        if (pym.getPaymentTypeId() == 2) {
                            ...
                            addTextToPrinter(printer, TextUtils.join(",", str), Printer.TRUE, Printer.FALSE, Printer.ALIGN_LEFT, 1, 1, 1);
//                        addTextToPrinter(printer, twoColumnsRightGreaterTr(
//                                TextUtils.join("," , str),
//                                ""
//                                ,
...
//                    else if (pym.getPaymentTypeId() == 8) {
//                        addTextToPrinter(printer, twoColumnsRightGreaterTr(
//                                  "AR/TAKAS",
...
//                }
                    ...
                    addTextToPrinter(printer, "Free of Charge", Printer.TRUE, Printer.FALSE, Printer.ALIGN_CENTER, 1,1,1);
