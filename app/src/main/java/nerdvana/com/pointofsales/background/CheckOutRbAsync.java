...
public class CheckOutRbAsync extends AsyncTask<Void, Void, Void> {
    ...
    public CheckOutRbAsync(PrintModel printModel, Context context, UserModel userModel, String currentDateTime, MainActivity.AsyncFinishCallBack asyncFinishCallBack) {
...
//                PrinterUtils.connect(context, printer);
                try {
                    printer.connect("TCP:" + printModel.getPrinterPath(), Printer.PARAM_DEFAULT);
                } catch (Epos2Exception e) {
                    e.printStackTrace();
                    try {
                        printer.disconnect();
...
//            asyncFinishCallBack.doneProcessing();
            ...
            if (toList1 != null) {
                ...
                if (toList1.getSpecial() > 0) {
                    PrinterUtils.addHeader(printModel, printer, 1);
