...
public class FetchRoomViaIdResponse {
    ...
    public class Result {
        ...
        public List<RoomRateSubViaId> getRoomRate() {
            return roomRate;
        }

        public void setRoomRate(List<RoomRateSubViaId> roomRate) {
    ...
    public class Type {
        ...
        public List<RoomRateMainViaId> getRoomRate() {
            return roomRate;
        }

        public void setRoomRate(List<RoomRateMainViaId> roomRate) {
            this.roomRate = roomRate;
        }
