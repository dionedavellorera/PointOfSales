...
public class FetchZReadListViaDateResponse {
    ...
    public class CutOff {
        ...
        @Expose
        private Cashier_ cashier;
        @SerializedName("duty_manager")
        @Expose
        private DutyManager_ dutyManager;
        ...
        public Cashier_ getCashier() {
            return cashier;
        }

        public void setCashier(Cashier_ cashier) {
            this.cashier = cashier;
        }

        public DutyManager_ getDutyManager() {
            return dutyManager;
        }

        public void setDutyManager(DutyManager_ dutyManager) {
